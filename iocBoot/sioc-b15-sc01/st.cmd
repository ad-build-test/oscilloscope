...
epicsEnvSet("IOC_NAME"  ,"SIOC:B15:SC01")
...
iocshLoad("$(TOP)/iocBoot/common/tds.cmd", "P=SCOP:B15:SC01,NODE_NAME=scop-amrf-rf01-lclsdev,REBOOT=")
#iocshLoad("$(TOP)/iocBoot/common/tds.cmd", "P=SCOP:B15:SC03,NODE_NAME=scop-amrf-rf03-lclsdev,REBOOT="#"")
